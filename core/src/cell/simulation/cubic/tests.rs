...
fn atoms_dir() -> Atoms {
    ...
    let mut atoms = vec![
        ...
        Atom { atom_type: Some(Element::Sr), position: Vector::new(-0.25, -0.25, -0.25)},
        Atom { atom_type: Some(Element::Sr), position: Vector::new(-0.25,  0.25, -0.25)},
        Atom { atom_type: Some(Element::Sr), position: Vector::new( 0.25, -0.25, -0.25)},
        Atom { atom_type: Some(Element::Sr), position: Vector::new( 0.25,  0.25, -0.25)},
        Atom { atom_type: Some(Element::Sr), position: Vector::new( 0.25, -0.25,  0.25)},
        ...
        Atom { atom_type: Some(Element::O), position: Vector::new(0.0, -0.25, 0.0)},
        Atom { atom_type: Some(Element::O), position: Vector::new(0.0,  0.25, 0.0)},
        Atom { atom_type: Some(Element::O), position: Vector::new(0.0, 0.0, -0.25)},
        Atom { atom_type: Some(Element::O), position: Vector::new(0.0, 0.0,  0.25)},
        Atom { atom_type: Some(Element::O), position: Vector::new(-0.25, 0.0, 0.0)},
        Atom { atom_type: Some(Element::O), position: Vector::new( 0.25, 0.0, 0.0)}
    ];
