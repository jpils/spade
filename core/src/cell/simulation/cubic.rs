...
fn sort_atoms(
    ...
    match dw_type {
        ...
        DWType::Apb => {
            let a_site_sorted = sort_a_site_atoms_apb(a_site, com)?;
            let x_site_sorted = sort_x_site_atoms_apb(x_site, com)?;
...
#[allow(clippy::needless_pass_by_value)] // TODO get rid of this
fn sort_a_site_atoms_apb(atoms: Atoms, com: Vector) -> Result<Atoms> {
    todo!()
}

#[allow(clippy::needless_pass_by_value)] // TODO get rid of this
fn sort_x_site_atoms_apb(atoms: Atoms, com: Vector) -> Result<Atoms> {
    todo!()
}
